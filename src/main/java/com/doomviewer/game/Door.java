...
public class Door {
    ...
    private double openCeilHeight;   // Ceiling height when fully open
    private double closedCeilHeight; // Ceiling height when fully closed
    private double speed;
    private long openTime;
    private long stayOpenDuration;
