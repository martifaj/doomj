...
public class GameDefinitions {
    private final Map<StateNum, StateDef> statesMap; // New map-based storage
    public final Map<MobjType, MobjInfoDef> mobjInfos; // MobjType enum as key for direct access
    public final Map<Integer, MobjType> doomedNumToMobjType; // For Thing.type to MobjType mapping
    ...
    private void populateLostSoul() {
        ...
        addState(StateNum.S_SKULL_STND, SpriteNames.SKUL, 0x8000, 10, Actions.A_LOOK, StateNum.S_SKULL_STND2);
        addState(StateNum.S_SKULL_STND2, SpriteNames.SKUL, 1 | 0x8000, 10, Actions.A_LOOK, StateNum.S_SKULL_STND);
        addState(StateNum.S_SKULL_RUN1, SpriteNames.SKUL, 0x8000, 6, Actions.A_CHASE, StateNum.S_SKULL_RUN2);
    ...
    private void populateWeapons() {
        ...
        addState(StateNum.S_PISTOLFLASH, SpriteNames.PISF, 0x8000, 7, Actions.A_LIGHT_1, StateNum.S_NULL);
        ...
        addState(StateNum.S_SGUNFLASH1, SpriteNames.SHTF, 0x8000, 4, Actions.A_LIGHT_1, StateNum.S_SGUNFLASH2);
        ...
        addState(StateNum.S_CHAINFLASH1, SpriteNames.CHGF, 0x8000, 5, Actions.A_LIGHT_1, StateNum.S_CHAINFLASH2);
        ...
        addState(StateNum.S_MISSILEFLASH1, SpriteNames.MISL, 0x8000, 3, Actions.A_LIGHT_1, StateNum.S_MISSILEFLASH2);
        ...
        addState(StateNum.S_PLASMAFLASH1, SpriteNames.PLSF, 0x8000, 4, Actions.A_LIGHT_1, StateNum.S_PLASMAFLASH2);
        ...
        addState(StateNum.S_BFGFLASH1, SpriteNames.BFGF, 0x8000, 11, Actions.A_LIGHT_1, StateNum.S_BFGFLASH2);
